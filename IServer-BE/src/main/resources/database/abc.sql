use `iserver-v1`;
INSERT INTO user (id, create_at, username, password, email, avatar, is_active, remember_token)
VALUES (1, '2023-05-26 10:30:00', 'john_doe', 'abc123', 'john@example.com', 'avatar.jpg', 1, 'XYZ123');
INSERT INTO user (id, create_at, username, password, email, avatar, is_active, remember_token)
VALUES (2, '2023-05-26 11:15:00', 'jane_smith', 'password456', 'jane@example.com', 'user.png', 1, NULL);
INSERT INTO user (id, create_at, username, password, email, avatar, is_active, remember_token)
VALUES (3, '2023-05-26 12:00:00', 'michael_johnson', 'pass789', 'michael@example.com', 'default.jpg', 0, 'ABC789');
INSERT INTO user (id, create_at, username, password, email, avatar, is_active, remember_token)
VALUES (4, '2023-05-26 13:30:00', 'hiennguyen', 'qwerty', 'longusername@example.com', 'user.jpg', 1, 'DEF321');
INSERT INTO user (id, create_at, username, password, email, avatar, is_active, remember_token)
VALUES (5, '2023-05-26 14:45:00', 'emma_smith', 'password123', 'emma@example.com', 'user2.jpg', 1, NULL);
select * from user;
